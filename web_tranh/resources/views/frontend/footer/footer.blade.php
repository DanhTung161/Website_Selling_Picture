        ...
        <div class="row py-4 my-5">
            <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                ...
                <ul class="list list-unstyled">
                    ...
                    <li class="pb-1 mb-2">
                        <span class="d-block font-weight-normal line-height-1 text-color-light">WORKING DAYS/HOURS
                        </span>
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <p class="mb-2">Get all the latest information on events, sales and offers. Sign up for newsletter:
                </p>
